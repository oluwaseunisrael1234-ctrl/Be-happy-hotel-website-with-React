...
const values = [
  ...
  { icon: 'fas fa-heart', title: 'Warmth', desc: 'Jamaican warmth and hospitality are the heart of everything we do at Be Happie.' },
    ...
    <div className="about-page">
      ...
      <section className="section-story">
        <div className="container story-grid">
          ...
          <div className="story-content">
            ...
            <h2 className="section-title">The Be Happie Story</h2>
            <div className="section-divider left"></div>
            <p>Founded in 2004 by the Campbell family, Be Happie Hotel and Suites was born from a passionate vision — to create a destination in Ocho Rios that blended authentic Jamaican spirit with world-class luxury hospitality.</p>
            ...
            <p>Our name, "Be Happie," reflects the experience so many of our guests describe upon their first visit — a feeling of immediate familiarity, warmth, and belonging. Like coming home to a place you've loved before.</p>
      ...
      <section className="section-timeline">
        <div className="container">
          ...
          <div className="timeline">
            {[
              { year: '2004', event: 'Be Happie Hotel & Suites opens with 12 rooms in Ocho Rios' },
              ...
              { year: '2016', event: 'Be Happie Spa & Wellness Center launches, offering luxury treatments' },
      ...
      <section className="about-cta">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center' }}>
          ...
          <h2>Experience Be Happie for Yourself</h2>

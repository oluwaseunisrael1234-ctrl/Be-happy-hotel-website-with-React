...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'Absolutely stunning hotel! The staff were incredibly welcoming and the rooms were beautifully appointed. Will definitely return to Be Happie on our next Jamaica trip!',
    avatar: 'S',
  },
  {
    name: 'James T.',
  ...
  },
  {
    ...
    rating: 5,
    text: 'We had the most wonderful honeymoon at Be Happie. The attention to detail and personalized service made our stay truly special. Thank you for everything!',
    avatar: 'M',
  },
]
      ...
      <section className="section-about">
        <div className="container about-grid">
          ...
          <div className="about-content">
            ...
            <p>Nestled in the heart of Ocho Rios, Jamaica, Be Happie Hotel and Suites has been a premier destination for discerning travelers since 2004. Our boutique property combines Jamaican charm with contemporary luxury to create an unforgettable experience.</p>

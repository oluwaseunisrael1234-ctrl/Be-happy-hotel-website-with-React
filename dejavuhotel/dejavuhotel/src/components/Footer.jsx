    ...
    <footer className="footer">
        ...
        <div className="container footer-grid">
          <div className="footer-col footer-about">
            <div className="footer-logo">
              ...
              <div>
                <span className="footer-logo-name">Deja Vu</span>
                <span className="footer-logo-sub">Hotel &amp; Suites</span>
              </div>
            </div>
            <p>Experience unmatched comfort and hospitality at Deja Vu Hotel and Suites — your home away from home in Ocho Rios, Jamaica.</p>
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-inner">
          <p>&copy; {new Date().getFullYear()} Deja Vu Hotel and Suites. All Rights Reserved.</p>

      ...
      <div className="booking-page">
        ...
        <div className="booking-confirmed">
          <div className="confirmed-box">
            ...
            <p>Thank you, <strong>{form.firstName} {form.lastName}</strong>! Your booking at Deja Vu Hotel and Suites has been confirmed. A confirmation email has been sent to <strong>{form.email}</strong>.</p>

...
const amenityCategories = [
  ...
  },
  {
    ...
    icon: 'fas fa-spa',
    items: [
      { name: 'Deja Vu Spa', desc: 'Immerse yourself in total relaxation with our full menu of treatments including massages, facials, body wraps, and traditional Jamaican healing therapies.', img: 'https://images.unsplash.com/photo-1507652313519-d4e9174996dd?w=600&q=80' },
